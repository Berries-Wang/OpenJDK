...
void ConcurrentMarkSweepPolicy::initialize_generations() {
    // 宏NEW_C_HEAP_ARRAY3定义于hotspot/src/share/vm/memory/allocation.hpp，使用AllocateHeap来分配内存
    //  _generations 是二级指针，类型为 GenerationSpec **
    ...
    if (UseParNewGC) {
         ...
         *  _generations[0] 年轻代
         *  _generations[1] 老年代
         *  在这里，new GenerationSpec并没有真正的分配内存
        */
