...
#define ARRAY_STOREFROM64(T, T2, stackSrc, extra)                                    \
      ...
      CASE(_monitorenter) : {
        ...
        if (entry != NULL) {
           ...
           * 
           * 
           * > 如果第一次进入synchronized代码块，mark->has_bias_pattern()应该是返回true的
           * --> (待验证!!!: 是这样的，请参考:005.OpenJDK/002.OpenJDK8u312-GA/OpenJDK8U312-GA/practice-code/SynchronizedLockTest.java)
