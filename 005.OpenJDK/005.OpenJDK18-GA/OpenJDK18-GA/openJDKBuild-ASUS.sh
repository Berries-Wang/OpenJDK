...
# 系统
# Linux Wang 5.15.0-56-generic #62~20.04.1-Ubuntu SMP Tue Nov 22 21:24:20 UTC 2022 x86_64 x86_64 x86_64 GNU/Linux
...
# BootJDK配置
BOOTJDK='/home/wei/WorkSpace/TempLibs/java-17-openjdk-17.0.5.0.8-2.portable.jdk.el.x86_64'
# 构建文件输出目录
...
bash configure  --with-debug-level=slowdebug    `# 指定可以生成最多的调试信息` \
